...
contract Exploit_WorkShop_TornadoCashGovernance is TestHarness {
    ...
    function test_attack_with_forked_foundry() external {
        ...
        // [STEP] Deploy the factory and proposal 20 (benign-like implementation) @audit
        // [STEP] Swap ETH for TORN @audit
        // [STEP] Lock TORN into the Tornado Cash Governance @audit
        vm.stopPrank();
        ...
        */
        ...
        // [STEP] Submit the proposal here to the Tornado Cash Governance @audit
        ...
        // [STEP] Deploy the Attacker1Contract @audit
        // [STEP] Deploy multiple accounts (minions) with that contract, for this case 5 accounts is fine.
        // @audit
        vm.stopPrank();
        ...
        vm.startPrank(ATTACKER2);
        // [STEP] Trigger the emergencyStop (selfdestruction) of the proposal and transient @audit
        vm.stopPrank();

        // Simulate selfdestruction in foundry local vm with a custom cheatcode
        // [STEP] Destroy the proposal 20 using foundry cheatcode @audit
        // [STEP] Destroy the transient contract using foundry cheatcode @audit
        ...
        vm.startPrank(ATTACKER2);
        // [STEP] Redeploy Transient and Proposal @audit
        vm.stopPrank();
